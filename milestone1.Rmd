...
Now set-up a public GitHub repository with a reasonable name for your project. We are using github.com and public repositories because we will eventually be using some fancy tooling (*e.g.,* GitHub Actions) in this project. For this to work, all your work for this project (including scripts) should be developed and live in this repository on GitHub.com.  Additionally, this will help you build a portfolio of your work you can share with others.
