...
An example final project can be seen here: 

- [Predicting Airbnb nightly price from property and host data](https://github.com/UBC-DSCI/predict-airbnb-nightly-price)
...
An example project milestone 1 can be seen here: [https://github.com/UBC-DSCI/predict-airbnb-nightly-price/tree/v1.0](https://github.com/UBC-DSCI/predict-airbnb-nightly-price/tree/v1.0)
