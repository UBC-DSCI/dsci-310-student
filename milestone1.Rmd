...
2. Set-up a public GitHub repository (or a private one, adding `ttimbers` and `GiuseppeTT` as collaborators with read access) under the [DSCI-310 organization](https://github.com/DSCI-310)
...
An example project milestone 1 will soon be available here: [https://github.com/UBC-DSCI/predict-airbnb-nightly-price/tree/v1.0](https://github.com/UBC-DSCI/predict-airbnb-nightly-price/tree/v1.0)

For now, it is still a work in progress (about 80% done): [https://github.com/UBC-DSCI/predict-airbnb-nightly-price](https://github.com/UBC-DSCI/predict-airbnb-nightly-price). You can checkout the [project board](https://github.com/UBC-DSCI/predict-airbnb-nightly-price/projects/1), and [milestone1](https://github.com/UBC-DSCI/predict-airbnb-nightly-price/milestone/1) to see what is left to do on this example.

### 1. Draft a team work contract

This document will govern the working relationships on your team, and if done correctly, it should help you manage and resolve any issues that might arise when working in a group. A sample team work contract from a past data science project can be found [here](sample-team-work-contract.html).
...
Now set-up a public GitHub repository (or a private one, adding `ttimbers` and `GiuseppeTT` as collaborators with read access) with a reasonable name for your project under the the [DSCI-310 organization](https://github.com/DSCI-310). We are using github.com and public repositories because we will eventually be using some fancy tooling (*e.g.,* GitHub Actions) in this project. For this to work, all your work for this project (including scripts) should be developed and live in this repository on GitHub.com.  Additionally, this will help you build a portfolio of your work you can share with others. *Note: if you need to change the name of your project repository later, you can!*

The tracking of the project will be done using [GitHub milestones](https://docs.github.com/en/issues/using-labels-and-milestones-to-track-work/about-milestones). When you create a milestone, you can associate it with issues and pull requests. After creating issues you can link them to a milestone associating each them to a project due date.

 In order to make more efficient team workflow, organize the issues you have previously associated with milestones into a [GitHub project board](https://docs.github.com/en/issues/organizing-your-work-with-project-boards/managing-project-boards/about-project-boards). We recommend you to use `Basic kaban` template that counts with "To do", "In progress", and "Done" columns.
