...
To install them, we will use the [Miniconda platform (read more here)](https://docs.conda.io/en/latest/miniconda.html).
Then [Miniconda MacOSX 64-bit pkg install for Python **3.x** can be downloaded here.](https://repo.anaconda.com/miniconda/Miniconda3-latest-MacOSX-x86_64.pkg).
...
It should open and look something like this picture below:
...
To launch the JupyterLab type the following in Terminal:
...
![](/resources_pages/imgs/jupyterlab_r_kernel.png)
...
![](/resources_pages/imgs/jupyterlab_r_kernel2.png)
