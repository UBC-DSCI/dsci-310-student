...
You will `source` (in the case of R) or `import` (in the case of Python) these functions in your literate code document (`*.ipynb`) to use them in your analysis.
...
(e.g., functions should do one thing, and generally return an object unless they were specifically designed for side-effects),
usability, 
