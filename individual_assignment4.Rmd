...
### Exercise instructions - R Markdown (reqiured)
...
3. Edit `doc/rmd_example/rmd_example.rmd` so that:
  ...
  - edit the figure captions so that they are automatically numbered by R Markdown ([docs on how to do this](https://bookdown.org/yihui/rmarkdown-cookbook/figure-number.html))
...
|Grade | Description |
|------|-------------|
| 110% | All 5 of the required edits to the `.Rmd` document above were met. And all 5 required edits to the Jupyter book above were met. |
| 100% | All 5 of the required edits to the `.Rmd` document above were met.  |
| 75%  | 4/5 of the required edits to the `.Rmd` document listed above were met. |
| 50%  | 3/5 of the required edits to the `.Rmd` document listed above were met. |
| 25%  | 2/5 of the required edits to the `.Rmd` document listed above were met. |
| 0%   | Only 1/5 of the required edits to the `.Rmd` document listed above were met or the assignment was not attempted. |
