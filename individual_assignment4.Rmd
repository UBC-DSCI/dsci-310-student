...
Goal: Famialrize yourself with the `Makefile` targets
...
- The RMarkdown file will may render on its own properly via the knit button in RStudio and using the `Makefile`
  at the same time.
