...
5. Write a bash script `run_all.sh` that will run all the scripts in the correct order in sequence.
...
<https://github.com/UBC-DSCI/dsci-310-student/blob/main/example_files/t6-quarto.qmd>
