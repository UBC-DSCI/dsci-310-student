...
- be in the DSCI 310 GitHub organization: https://github.com/orgs/UBC-DSCI-310-2025W2
...
- have a badge for tests passing
...
- have a code of conduct document
  that describes behavioral expectations of team interactions
...
(and relevant feedback received from the peer review).
...
You will links to Gradescope for Milestone 4 that includes:
