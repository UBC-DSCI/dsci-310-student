...
*You can acces an editable version of this file [here](https://github.com/UBC-DSCI/dsci-310-student/team-work.Rmd).*
...
- Fill out this form (editable version of the form available [here](https://github.com/UBC-DSCI/dsci-310-student/team-work.Rmd)) and convert it to an `.html` document. Finally submit it to Canvas.