...
|Grade | Description |
|------|-------------|
| 110% | A working toy R package, working toy Python package with a pyopensci contribution |
...
| 75%  | A working toy R package was created as described in the [The whole game](https://r-pkgs.org/whole-game.html).|
