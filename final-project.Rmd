...
- be named the same as your group project repositry, with the addition of `-pkg` at the end.
...
- remove the files that contain your functions
  (you no longer need these since you are loading them from your pacakge),
...
You do this by going to the repsitory Settings > General > Danger Zone > Transfer Owner > Select DSCI-310
...
You will submit four (4) URLS's to Canvas in the provided text box for the final project:

1. URL of your project's GitHub.com repository (remeber to transfer your repository to be marked)
