...
| [Milestone 3](milestone3.html)  | literate code document broken into scripts and a report & data analysis pipeline to stitch everything together (`.R` files & Make pipeline, `bookdown` or `rticle` report) | 10% | 2022/03/26 18:00 |
