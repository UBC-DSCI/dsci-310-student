...
|-------|-------|--------------|-----------------|----------------|
| Instructor | Daniel Chen | daniel.chen[-at-]stat.ubc.ca | Tuesday 8:00 AM - 9:00 AM | Zoom |
| TA | Amy Kong | ---- | Tuesday 10:30 AM - 11:30 AM | Zoom |
| TA | Tony Liang | ---- | Wednesday 3:00 PM- 4:00 PM | Zoom |
...
|--------------------|-----------------------|---------|
| Individual assignment 1 | Setting up your computer | 2022/01/21 23:59 |
| GitHub username quiz | | 2022/01/21 23:59 |
| Individual assignment 2 | Version control practice | 2022/01/28 23:59 |
| Individual assignment 3 | Dockerfile practice | 2022/02/04 23:59 |
| Milestone 1    | Question, data & rough draft of analysis in one monolithic literate code document, reproducible environment (`full.ipynb`, `Dockerfile`, `docker-compose.yml`) | 2022/02/18 23:59 |
| Mid-term exam | | 2022/03/04 09:00 |
| Milestone 2 | functions abstracted to a file/module & tests (`reduced.ipynb`, `.R` & `test_*.R`, function documentation) | 2022/03/11 23:59  |
| Individual assignment 4 | Reproducible reports practice | 2022/03/18 23:59 |
| Milestone 3  | literate code document broken into scripts and a report & data analysis pipeline to stitch everything together (`.R` files & Make pipeline, `bookdown` or `rticle` report) | 2022/03/25 23:59 |
| Peer review | review of another group's project | 2022/04/01 23:59 |
| Individual assignment 5 | Packaging practice | 2022/04/01 23:59 |
| Final project | package & CI (the full monty package - including docs) | 2022/04/08 23:59 |
