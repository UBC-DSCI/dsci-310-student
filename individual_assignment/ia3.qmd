...
1. A link to the GitHub.com repository that you create for this assignment.
    ...
    - You need to create this assignment in the course organization: UBC-DSCI-310-2025W2
2. A the link to your Docker image on DockerHub. You should name your DockerHub repository `dsci310-ia3-<USERNAME>-docker`.

:::{.callout-warning}
Make sure your repository is under the class GitHub organization.
...
1. A Docker image named `dsci310-ia3-<USERNAME>-docker ` and tagged with a version exists under the student's username on DockerHub.
...
| Grade | Description                                                                         |
| ----- | ----------------------------------------------------------------------------------- |
| 100%  | 4/4 of the criteria listed above were met.                                          |
